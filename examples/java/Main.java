...
public class Main {
    ...
    private static final String MARKET = "ES";
    private static final String EXCHANGE = "BME";
    private static final String SYMBOL = "BME:000040";
                ...
                .buildAsync(URI.create(WS_URL), new WebSocket.Listener() {
                    ...
                    public void onOpen(WebSocket webSocket) {
                        String subscribeJson = "{\"action\":\"subscribe\",\"market\":\"" + MARKET
                                + "\",\"exchange\":\"" + EXCHANGE
                                + "\",\"symbols\":[\"BME:000040\",\"BME:005930\"],\"replay\":\"last\"}";
